...
CREATE TABLE `automoveis` (
  `idautomoveis` int NOT NULL AUTO_INCREMENT,
  `morador_idmorador` int NOT NULL,
  `marca` varchar(45) DEFAULT NULL,
  `modelo` varchar(45) DEFAULT NULL,
  `placa` varchar(45) DEFAULT NULL,
  `ativo` tinyint DEFAULT NULL,
  PRIMARY KEY (`idautomoveis`,`morador_idmorador`),
  KEY `fk_automoveis_morador_idx` (`morador_idmorador`),
  CONSTRAINT `fk_automoveis_morador` FOREIGN KEY (`morador_idmorador`) REFERENCES `morador` (`idmorador`)
...
INSERT INTO `automoveis` VALUES (1,1,'Volkswagen','Fox Branco','FOX-1234',NULL);
...
-- Dump completed on 2021-04-08 18:35:11
