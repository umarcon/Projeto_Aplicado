...
CREATE TABLE `fechamento_caixa` (
  `idfechamento_caixa` int NOT NULL AUTO_INCREMENT,
  `anomes` varchar(6) DEFAULT NULL,
  `total_despesa` decimal(10,2) DEFAULT NULL,
  `total_receita` decimal(10,2) DEFAULT NULL,
  `saldo` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`idfechamento_caixa`)
...
-- Dump completed on 2021-04-08 18:35:01
