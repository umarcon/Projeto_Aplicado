...
CREATE TABLE `ocorrencias` (
  ...
  `ocorrencia` varchar(4000) DEFAULT NULL,
  `data` date DEFAULT NULL,
  PRIMARY KEY (`idocorrencias`,`morador_idmorador`),
  KEY `fk_ocorrencias_morador1_idx` (`morador_idmorador`),
  CONSTRAINT `fk_ocorrencias_morador1` FOREIGN KEY (`morador_idmorador`) REFERENCES `morador` (`idmorador`)
...
-- Dump completed on 2021-04-08 18:35:12
