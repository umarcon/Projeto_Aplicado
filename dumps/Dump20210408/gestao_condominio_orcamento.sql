...
CREATE TABLE `orcamento` (
  ...
  `valor` decimal(8,2) unsigned zerofill DEFAULT NULL,
...
INSERT INTO `orcamento` VALUES (1,'João Pedro Serralheria',002500.00,'Manutenção do portão externo para corrigir o problema da quebra do cabo de aço do portão.');
